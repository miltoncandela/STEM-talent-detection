...
def leave_one_out(metric, imbalance_solver=False):
    ...
    fig.savefig('figures/results/{}_top_correlated_features_bar_plot.pdf'.format(metric), bbox_inches='tight')
    ...
    fig.savefig('figures/results/{}_prediction.pdf'.format(metric), bbox_inches='tight')
